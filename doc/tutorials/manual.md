...
地图更新完之后，我们可以使用对比窗口里的对比地图或者对比源文件，来查看我们做了哪些修改。

![变更](../images/tutorials/manual-diff.png)

在这个窗口，我们能看到对文件进行的变更，对于有问题的话，我们还能选择性的进行撤销(回退到原始版本)。

如果我们有多个数据差不多，用途不同的地图文件，我们也可以对比原始文件，选择生成补丁，然后在其他版本的文件中进行选择性的应用，避免重复工作。
